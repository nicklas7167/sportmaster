  ...
  const upgradeToPremiumMutation = useMutation({
    ...
    onSuccess: (user: SelectUser) => {
      ...
      toast({
        ...
        description: "You now have premium access! Enjoy all our premium predictions.",
      });
      // Invalidate predictions to refresh UI with unlocked content
      queryClient.invalidateQueries({ queryKey: ["/api/predictions"] });
    },
    onError: (error: Error) => {
      toast({
        title: "Upgrade failed",
        description: error.message || "Could not upgrade to premium at this time",
        variant: "destructive",
      });
    },
  });
